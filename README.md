...
$$
\pi_\theta(a_t \mid s_t) = \pi_\theta(P_t \mid s_t) \cdot \prod_{k=1}^{K_t} \pi_\theta\bigl(r_{t,k} \mid s_t,\, P_t,\, r_{t,1}, \ldots, r_{t,k-1}\bigr). \qquad (3)
$$
