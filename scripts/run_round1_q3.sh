#!/bin/bash
# Round 1 (Qwen3-4B): Same pipeline but with Qwen3-4B-Instruct as planner/router
...
# Planner + Router: local Qwen3-4B-Instruct (GPU 4, port 8234)
...
API_KEY="sk-7Yv0jGTYpFErrvpnVIlz3cGOtxIuwucfMT5fSxYalwVWprL0"
...
echo "=== Round 1 (Qwen3-4B-Instruct): Bootstrapped Curriculum Filtering ==="
