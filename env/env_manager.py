...
from env.memory import SimpleMemory, SearchMemory
...
def make_envs(config):
    ...
    if "search" in config.env.env_name.lower():
        from env.env_package.search import build_search_envs, search_projection
        ...
        from env.env_package.gym_cards import build_gymcards_envs, gym_projection
        ...
        from env.env_package.alfworld import build_alfworld_envs, alfworld_projection
        ...
        from env.env_package.sokoban import build_sokoban_envs, sokoban_projection
        env_kwargs = {
        ...
        from env.env_package.webshop import build_webshop_envs, webshop_projection
        ...
        from env.env_package.appworld import build_appworld_envs, appworld_projection
        ...
        from env.env_package.uno import build_uno_envs, uno_projection
        from env.env_package.uno.env_manager import UnoEnvironmentManager
